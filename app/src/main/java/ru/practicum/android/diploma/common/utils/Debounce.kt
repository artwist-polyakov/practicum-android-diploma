...
/**
 *Этот Kotlin класс определяет функцию debounce, которая создает и возвращает замыкание с дебаунс-логикой для переданной функции action.
 * Дебаунсинг используется для ограничения скорости вызова функции, то есть функция action будет вызвана не чаще, чем указано в параметре delayMillis.
 *
